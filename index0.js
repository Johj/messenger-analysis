...
const conversationInitByMonth = require('./util/conversationInitByMonth.js');
...
const name = 'conversationInitByMonth';
const processed_data = processData(data, name, conversationInitByMonth);
...
for (let index = 0; index < 10; ++index) {
  ...
  const title = `"Conversation Initialized by Month"`;
  const rotate = 90;
  const type = `"bar"`;
